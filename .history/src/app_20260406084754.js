  ...
  if (!state.projects.length) {
    ...
    emptyState.innerHTML = `
      <div class="empty-card">
        ...
        <p>Drop files or whole folders on the canvas. Projungle will auto-tag them, cluster them into projects, and keep your original files exactly where they are.</p>
      </div>
    `;
    return;
  }
